...
describe('preloadCSL', () => {
  ...
  it('should fallback to setTimeout when requestIdleCallback is not available', () => {
    ...
    delete (global.window as unknown as { requestIdleCallback?: unknown }).requestIdleCallback;
  ...
  it('should not preload if already loaded', () => {
    ...
    const requestIdleCallbackSpy = jest.spyOn(global.window as unknown as { requestIdleCallback: () => void }, 'requestIdleCallback');
...
describe('LazyCSL', () => {
  ...
  describe('createTxOutput', () => {
    ...
    it('should create transaction output with native assets', async () => {
      ...
      await LazyCSL.createTxOutput('addr1test', '1000000', assets);
...
describe('Integration scenarios', () => {
  ...
  it('should use cached CSL across different utilities', async () => {
    ...
    await LazyCSL.bigNumFromStr('1000000');
